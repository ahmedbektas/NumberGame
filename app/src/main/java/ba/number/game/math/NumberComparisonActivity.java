...
public class NumberComparisonActivity extends ActionBarActivity {
    Bundle bundle;
...
//u bundle snimam podatke iz MainActivity-a
    ...
    public void ubaciFragment(){
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.container, NumberComparisonFragment.newInstance(Integer.valueOf(bundle.getString("numberLimit"))))
                .commit();
    }
