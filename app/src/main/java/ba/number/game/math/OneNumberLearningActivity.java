...
public class OneNumberLearningActivity extends ActionBarActivity {
...
//u bundle snimam podatke iz MainActivity-a
    ...
    public void ubaciFragment(){
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.container, OneNumberLearningFragment.newInstance(Integer.valueOf(bundle.getString("numberLimit"))))
                .commit();
    }
